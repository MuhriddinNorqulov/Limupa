...
// import './admin_static/vendor/fontawesome-free/css/all.min.css'
// import './admin_static/css/sb-admin-2.min.css'

import rocket from "./admin_static/img/undraw_rocket.svg"
            ...
            <div id="page-top">
                ...
                <div id="wrapper">
                    ...
                    <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                        ...
                        <li className="nav-item">
                            <Link to='/admin/users' className="nav-link collapsed" data-toggle="collapse">
                        ...
                        <div className="sidebar-card d-none d-lg-flex">
                            ...
                            {/*   href="https://startbootstraph3.com/theme/sb-admin-pro">Upgrade to Pro!</a>*/}
                        </div>
