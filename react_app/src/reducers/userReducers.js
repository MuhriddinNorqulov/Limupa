...
export const userSendVerificationCodeReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_SEND_VERIFICATION_CODE_REQUEST:
            return { loading: true }

        case USER_SEND_VERIFICATION_CODE_SUCCESS:
            return {loading: false, success: true, phone: action.payload.phone}

        case USER_SEND_VERIFICATION_CODE_FAIL:
            return {loading: false, error: action.payload}

        case USER_SEND_VERIFICATION_CODE_RESET:
            return {}
...
export const userCheckCodedReducer = (state = {}, action) => {
    switch (action.type){
